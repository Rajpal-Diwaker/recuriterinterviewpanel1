        ...
        <div class="left-sidebar-scroll">
          <div class="left-sidebar-content">
            <ul class="sidebar-elements">
              ...
              <?php if($this->uri->segment(2)=='Podcast' && $this->uri->segment(3)!='dashboard'){ $show='open';  }else{ $show='';  } ?>
              <li class="parent <?php echo $show; ?>"><a href=""><i class="icon mdi mdi-collection-item-1"></i><span>Podcast Management</span></a>
                <ul class="sub-menu">
                  <li><a href="<?php echo(ADMINURL.'Podcast/podcast_management/'); ?>">Podcast Listing</a></li>
                  <li><a href="<?php echo(ADMINURL.'Podcast/addPodcast/'); ?>">Add New Podcast</a></li>
                </ul>
              </li>
            </ul>
          </div>
