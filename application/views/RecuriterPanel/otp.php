				...
				<div class="col-sm-5 col-md-5">
					<div class="login-content">
						<div class="login-text verify">
							...
							<h5>OTP sent to <?php echo $this->session->userdata('adminEmail'); ?></h5>
							<?php
							...
							?>
							<form action="<?php echo base_url('Recruiter/submitOTP') ?>" method="post">
								<div class="form-group">
									<div class="row clearfix">
										<input type="hidden" name="email" value="<?php echo $this->session->userdata('adminEmail'); ?>">
...
<script>
	var email = '<?php echo $this->session->userdata('adminEmail'); ?>';
	...
	function ResendOTP() {
		var email = '<?php echo $this->session->userdata('adminEmail'); ?>';
		$.ajax({
			url: '<?php echo base_url(); ?>Recruiter/reSendOTP',
			type: 'POST',
			dataType: "json",
			data: {
				'email': email
	...
	function verifyOTP() {
		...
		console.log("<?php echo base_url(); ?>Recruiter/dashboard");

		window.location.href = "<?php echo base_url(); ?>Recruiter/dashboard"
