    ...
    <!--PodCast Start Here-->
    <div class="podcast-wrap detail-wrap">
      ...
      <div class="content-wrapper">
        <div class="container-wrapper">
          <div class="podcast-contents clearfix">
            <div class="row">
              <?php 
                if($podcastArr['type'] =='audio'){
                  ?>
                  <div class="col-sm-12">
                    <div class="content-listing">
                      <div class="audio-rw">
                        <div class="audio-wrap"> 
                            <img src="<?php echo $podcastArr['podcast_thumbnail'] ?>" alt="">
                        </div>
                        ...
                        <!-- <audio controls>
                          ...
                          <audio  controls controlsList="nodownload" id="audio-example" class="audio-example" style="display:none;">
                            <source src="<?php echo $podcastArr['podcast_media'] ?>"> 
                              <source src="<?php echo $podcastArr['podcast_media'] ?>">
                              </audio>
                            </div>
                            <div class="content-rw">
                              <div class="podcastlistheading"><?php echo $podcastArr['podcast_title'] ?></div>
                              <div class="podcastdescription"><?php echo $podcastArr['podcast_content'] ?></div>
                              <div class="greylines"></div>
                              <div class="about-author">
                                <span><?php echo $podcastArr['created_on']; ?> / </span>
                                <span><?php echo $podcastArr['created_by']; ?>  </span>
                              </div>
                            </div>
                          </div>
                        </div>
                      <?php }else{ ?>
                       <div class="col-sm-12">
                        <div class="content-listing">
                          <a class="youtube-link" youtubeid="<?php echo $podcastArr['youtube_id'] ?>">
                            <div class="audio-rw">
                              <div class="audio-wrap"> 
                              <img src="<?php echo $podcastArr['podcast_thumbnail'] ?>" alt="title">
                              </div>
                              <div class="video-image">
                                <img src="<?php echo BASEURL.'/assets/images/play.png' ?>" class="player-img">
                              </div>
                            </div>
                          </a>
                          <div class="content-rw">
...
<script src="<?php echo(ADMIN.'/js/grt-youtube-popup.js'); ?>" type="text/javascript"></script>
  ...
  var sendRequest = function(){
    ...
    window.location.href = '<?=base_url('ask-the-experts')?>?query='+searchKey;
  }
  var searchKey;
...
//     $("#audio-example").css("display","block")
