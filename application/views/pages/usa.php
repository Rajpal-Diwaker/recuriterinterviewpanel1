  <!--Mobile App Development Company USA Page Content Start Here-->

        <!--Banner Start Here-->
        <div class="mobileappdevebanwrap iosdevlopment nodejs countrypg clearfix">
            <div class="appdevimgbx reactdev" data-aos="fade-in" data-aos-easing="ease-in-sine" data-aos-duration="600"> <img src="<?= base_url(); ?>assets/images/mobile-app-development-company-usa-banner.png" alt="Mobile App Development Company USA" /></div>
        ...
        COMPANY IN <span class="countrynm">USA</span></h1>
            ...
            <div class="number_accolades_wrap clearfix">
                ...
                <div class="accoladesnuminfodetailsbox">
                    <div class="detailsinfobx">
                        <h4>A glimpse of our handful</h4>
                        <h3>NUMBERS AND ACCOLADES</h3>
                        <div class="smtinfo">
                            <p>Techugo has been selected as the chosen partner for Fortune 500 and Global 2000 companies to promising startups across the world. In the span of 4+ years. As a leading Mobile app development company in usa, we have garnered the attention of bigger enterprises, brands, and startups globally.</p>
                            <p>Techugo has been a trusted partner for many renowned brands and has helped many industries to implement technology into their business model effortlessly. Our team of experienced designers, programmers and quality assurance specialists, are proficient in mobile app development strategy and in delivering the best mobile applications to the clients. Our expertise lies in building customized mobile apps for all domains, and every new technological trend like AI, AR, VR, IoT are part of our development process.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mobiledevStepwrap">
                ...
                <div class="mobilestep_devrow maintenance clearfix">
                    ...
                    <div class="stepinfodetailsCon">
                        ...
                        <div class="smtinfo">For us working for your app is the high priority aspect, wherein, once the app goes live, we initiate another journey starts, which requires constant tracking and updates from the experts. We keep a track on every activity of the app and make the necessary changes, where required. We follow an end to end process for this phase of the project. We bring a FREE period of after support for a specific time, to help your app grow popular.</div>
                    </div>
                </div>
            </div>
...
$(function() {
  $(window).scroll(function() {
    ...
    if (y > 800) {
        $('#haveanIdea').modal('show');
        
    } else {
        $('#haveanIdea').modal('hide');
    }
  });
//   $('#haveanIdea').modal({
//     backdrop: 'static',
