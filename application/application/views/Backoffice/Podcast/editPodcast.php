          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <div class="card card-border-color card-border-color-primary">
                <div class="card-body">
                  <form id="uploadForm" action="<?php echo(ADMINURL.'Podcast/editPodcastprocess'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group pt-2">
                      <label for="blog_title">Podcast Title</label>
                      <input class="form-control" id="post_title" type="text" placeholder="Podcast Title" value="<?php echo $postArr['podcast_title']; ?>" name="post_title" required>
                    </div>

                    <div class="form-group field-videolang-name-en required">
                        <label for="editor1">Podcast Content</label>
                        <textarea id="editor1" name="post_content" class="form-control" ><?php echo $postArr['podcast_content']; ?></textarea>  
                    ...
                    <div class="form-group row">
                      <div class="form-group pt-2 col-md-6">
                        ...
                        <select class="selectcate form-control" name="type" id="type" >
                            ...
                            <option value="audio" <?php if($postArr['type']=='audio'){  echo 'selected'; } ?> >Audio</option>
                            <option value="video" <?php if($postArr['type']=='video'){  echo 'selected'; } ?>>Video</option>
                        </select>
                      </div>   
                      <div class="form-group pt-2 col-md-6">
                        <label for="meta_keywords">Author Name</label>
                        <input class="form-control" type="text" list="created_by" name="created_by" placeholder="Author Name" autocomplete="off" required="" value="<?php echo $postArr['created_by']; ?>" />
                    ...
                    <div class="form-group pt-2">
                      ...
                      <input class="form-control" id="youtube_url" type="text" placeholder="Youtube Url" name="youtube_url" value="<?php echo $postArr['youtube_url']; ?>">
                    </div>
                    <div class="form-group row">
                    ...
                    <input type="hidden" name="podcast_id" value="<?php echo $postArr['podcast_id']; ?>">
                    <div class="row pt-3">
                      <div class="col-sm-6">
                        <p class="text-left">
