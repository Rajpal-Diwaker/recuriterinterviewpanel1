    ...
    <div style="max-width:650px; margin:auto; font-family:Arial, Helvetica, sans-serif;">
        <table width="100%" style="background:url('https://lal10bucketiam.s3-ap-south-1.amazonaws.com/LAL10_1602617816514.jpg'); background-repeat:no-repeat; background-size:cover; background-position:center; padding:65px 20px 135px 20px;" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                line-height:30px;padding:15px;"> Hello <?php echo $ResumeUser['name']; ?> ,
                </td>
            </tr>
            <tr>
                <td style="font-size:15px; font-family: 'Montserrat-Bold'; text-align:left; color:#000;
                line-height:30px;padding:15px;">
                    This is a hard email to write and even harder to let <br>
                    you know that your expertise and our requirement at Techugo <br>
                    do not have a match. We are sorry to let you know that your <br>
                    candidature has been rejected. <br><br>
                    We really appreciate your interest in joining Techugo. <br>
                    We would love to have you on our social channels and would be
                    <br>happy to be connected socially</td>
            </tr>
            <tr>
                <td style="font-size:15px; font-family: 'Montserrat-Bold'; text-align:left; color:#000;
            ...
            <tr>
                <td style="font-size:15px; font-family: 'Montserrat-Bold'; text-align:left; color:#000;
                line-height:30px;padding:15px;"> We wish you the very best and hope to work with you sometime in the future. </td>
            </tr>
            </tr>
            <tr>
                <td style="font-size:15px; font-family: 'Montserrat-Bold'; text-align:left; color:#000;
