...
class Recruiter extends CI_Controller
{
    ...
    public function dashboard()
    {
        if (empty($this->session->userdata('adminId'))) {
            ...
            $data['totalInterview'] = $this->Recuriter->getTotalInterview();
            $data['totalInterviewT'] = $this->Recuriter->getTotalInterviewT();

            for ($i = 0; $i < count($data['totalInterview']); $i++) {
                $totalInterview[$i]['indexLabel'] =  $data['totalInterview'][$i]['profile'];
                $totalInterview[$i]['y'] =  $data['totalInterview'][$i]['totalInterview'];
            }

            $data['totalPendingInterview'] = $this->Recuriter->getTotalPendingInterview();
            $data['totalPendingInterviewT'] = $this->Recuriter->getTotalPendingInterviewT();
            ...
            $data['totalHireInterview'] = $this->Recuriter->getTotalHireInterview();
            $data['totalHireInterviewT'] = $this->Recuriter->getTotalHireInterviewT();

            for ($i = 0; $i < count($data['totalHireInterview']); $i++) {
                $totalHireInterview[$i]['x'] =  $data['totalHireInterview'][$i]['profile'];
                $totalHireInterview[$i]['y'] =  $data['totalHireInterview'][$i]['totalInterview'];
            }

            $data['totalRejectedInterview'] = $this->Recuriter->getTotalRejectedInterview();
            $data['totalRejectedInterviewT'] = $this->Recuriter->getTotalRejectedInterviewT();

            for ($i = 0; $i < count($data['totalRejectedInterview']); $i++) {
                $totalRejectedInterview[$i]['indexLabel'] =  $data['totalRejectedInterview'][$i]['profile'];
                $totalRejectedInterview[$i]['y'] =  $data['totalRejectedInterview'][$i]['totalInterview'];
            }

            $data['totalStronglyInterview'] = $this->Recuriter->getTotalStronglyHireInterview();
            $data['totalStronglyInterviewT'] = $this->Recuriter->getTotalStronglyHireInterviewT();

            for ($i = 0; $i < count($data['totalStronglyInterview']); $i++) {
                $totalStronglyInterview[$i]['indexLabel'] =  $data['totalStronglyInterview'][$i]['profile'];
                $totalStronglyInterview[$i]['y'] =  $data['totalStronglyInterview'][$i]['totalInterview'];
            }

            $data['totalHoldInterview'] = $this->Recuriter->getTotalHoldInterview();
            $data['totalHoldInterviewT'] = $this->Recuriter->getTotalHoldInterviewT();

            for ($i = 0; $i < count($data['totalHoldInterview']); $i++) {
                $totalHoldInterview[$i]['indexLabel'] =  $data['totalHoldInterview'][$i]['profile'];
                $totalHoldInterview[$i]['y'] =  $data['totalHoldInterview'][$i]['totalInterview'];
            }
            ...
            // echo '<pre>';
            // print_r($data['dataPoints3']);
            // die;

            $this->load->view('RecuriterPanel/header');
            $this->load->view('RecuriterPanel/dashboard', $data);
        }
    }
